...
export default async function Video({ params }: PageProps) {
    ...
    if (data.status !== 200) {
        ...
        url: `https://viraldigilir.pages.dev/v/${file.file_code}#${file.file_title}`,
        ...
        publisher: {
            '@type': 'Organization',
            name: `${SITENAME}`,
            logo: 'https://viraldigilir.pages.dev/favicon.ico'},
            author: {
                '@type': 'Person',
                name: 'admin',
        ...
        interactionStatistic: {
            ...
            interactionType: {
                '@type': `ReadAction`,
                target: `https://viraldigilir.pages.dev/v/${file.file_code}#${file.file_title}`
            }  
        }
        }
